...
export class BookinstanceApiService {
  ...
  createBookInstance(data): Observable<any> {
    let url = `${this.baseUri}/bookinstance/create`;
  ...
  getBookInstances() {
    return this.http.get(`${this.baseUri}/bookinstances`);
  }

  //get single bookinstance
  getBookinstance(id): Observable<any> {
    let url = `${this.baseUri}/bookinstance/${id}`;
  ...
  updateBookInstance( data): Observable<any> {
    let url = `${this.baseUri}/bookinstance/${data.id}`;
